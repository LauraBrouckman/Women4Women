...
class RemoteDatabase {
    ...
    */
    ...
    func addNewUser(_ username: String, firstName: String, lastName: String, locationLat: Double, locationLon: Double)
    {
    ...
    func getUserFromDB(_ username: String, completionHandler: @escaping (Any?) -> ()) {
    ...
    func updateUserLocation(forUser username: String, locationLat: Double, locationLon: Double) {
    ...
    func updateUserName(forUser username: String, firstName: String, lastName: String) {
        let currentUserRef = usersRef.child(username)
    ...
    func updateProfilePicture(_ username: String) {
        uploadFileToDatabase(forUser: username)
    }
   ...
   // Below are helper functions that are used to get from local storage a file called profile_pic.png and upload it under a random filename to the remote database
    ...
    fileprivate func uploadFileToDatabase(forUser username: String) {
