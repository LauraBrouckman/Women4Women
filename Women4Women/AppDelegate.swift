...
//  Women4Women
//
//  Created by Laura Brouckman on 5/1/17.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        if UserDefaults.getNightOccuring() {
            ...
            if let outingEndTime = UserDefaults.getHomeTime() {
                print("OUTING DATE IS")
                print(dateFormatter.string(from: outingEndTime))
                print(currentDate > outingEndTime)
                if currentDate > outingEndTime {
...
//        
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "Women4Women")
