...
open class AccordionTableViewController: UITableViewController {
    ...
    let timeChildCellIndentifier = "timeChildCell"
    
    let homeChildCellIdentifier = "homeChildCell"
    
    let contactChildCellIdentifier = "contactChildCell"
    ...
    var firstCellExpanaded : Bool = false
